...
{
    public partial class FrmUtilizadorescs : Form
    {
        ...
        private void GridViewUtilizadores_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (colName == "Editar")
            {
                ...
                editarUtilizador.drop_ativo.SelectedItem = GridViewUtilizadores.Rows[e.RowIndex].Cells[4].Value.ToString();
